...
mod private {
    ...
    impl_conversions!(String, BSTR, VT_BSTR, bstrVal, bstrVal_mut);
    ...
    impl<'s, S> VariantAccess for Vec<S>
    where
        S: SafeArrayElement
    {
    ...
    impl_conversions!(Box<bool>, *mut VARIANT_BOOL, VT_PBOOL, pboolVal, pboolVal_mut);
    ...
    impl_conversions!(Box<String>, *mut BSTR, VT_PBSTR, pbstrVal, pbstrVal_mut);
...
pub trait VariantExt<B>: self::private::VariantAccess { //Would like Clone, but *mut IDispatch and *mut IUnknown don't implement them
...
mod test {
    ...
    macro_rules! validate_variant {
        ($t:ident, $b:ident, $val:expr, $vt:expr) => {
            ...
            let var = <$t as VariantExt<$b>>::from_variant(var);
            assert_eq!(v, var.unwrap());
            };
    }
    #[test]
    fn test_i64() {
        validate_variant!(i64, i64, 1337i64, VT_I8);
    }
    #[test]
    fn test_i32() {
        validate_variant!(i32, i32, 1337i32, VT_I4);
    }
    #[test]
    fn test_u8() {
        validate_variant!(u8, u8,  137u8, VT_UI1);
    }
        #[test]
    fn test_i16() {
        validate_variant!(i16, i16, 1337i16, VT_I2);
    }
    #[test]
    fn test_f32() {
        validate_variant!(f32, f32, 1337.9f32, VT_R4);
    }
    #[test]
    fn test_f64() {
        validate_variant!(f64, f64, 1337.9f64, VT_R8);
    }
    #[test]
    fn test_bool_t() {
        validate_variant!(bool, VariantBool, true, VT_BOOL);
    }

    #[test]
    fn test_bool_f() {
        validate_variant!(bool, VariantBool, false, VT_BOOL);
    }

    #[test]
    fn test_scode() {
        validate_variant!(SCode, SCode, SCode::from(137), VT_ERROR);
    }

    #[test]
    fn test_cy() {
        validate_variant!(Currency, Currency, Currency::from(137), VT_CY);
    }

    #[test]
    fn test_date() {
        validate_variant!(Date, Date, Date::from(137.7), VT_DATE);
    }

    #[test]
    fn test_str() {
        validate_variant!(String, U16String, String::from("testing abc1267 ?Ťũřǐꝥꞔ"), VT_BSTR);
    }

    #[test]
    fn test_box_u8() {
        type Bu8 = Box<u8>;
        validate_variant!(Bu8, Bu8, Box::new(139), VT_PUI1);
    }

    #[test]
    fn test_box_i16() {
        type Bi16 = Box<i16>;
        validate_variant!(Bi16, Bi16, Box::new(139), VT_PI2);
    }
    #[test]
    fn test_box_i32() {
        type Bi32 = Box<i32>;
        validate_variant!(Bi32, Bi32,  Box::new(139), VT_PI4);
    }
    #[test]
    fn test_box_i64() {
        type Bi64 = Box<i64>;
        validate_variant!(Bi64, Bi64, Box::new(139), VT_PI8);
    }
    #[test]
    fn test_box_f32() {
        type Bf32 = Box<f32>;
        validate_variant!(Bf32, Bf32, Box::new(1337.9f32), VT_PR4);
    }
    #[test]
    fn test_box_f64() {
        type Bf64 = Box<f64>;
        validate_variant!(Bf64, Bf64,  Box::new(1337.9f64), VT_PR8);
    }
    #[test]
    fn test_box_bool() {
        type Bbool = Box<bool>;
        type BVb = Box<VariantBool>;
        validate_variant!(Bbool, BVb,  Box::new(true), VT_PBOOL);
    }
    #[test]
    fn test_box_scode() {
        type BSCode = Box<SCode>;
        validate_variant!(BSCode, BSCode, Box::new(SCode::from(-50)), VT_PERROR);
    }
    #[test]
    fn test_box_cy() {
        type BCy = Box<Currency>;
        validate_variant!(BCy, BCy, Box::new(Currency::from(137)), VT_PCY);
    }
    #[test]
    fn test_box_date() {
        type BDate = Box<Date>;
        validate_variant!(BDate, BDate, Box::new(Date::from(-10.333f64)), VT_PDATE);
    }
    #[test]
    fn test_box_str() {
    ...
    #[test]
    fn test_i8() {
        validate_variant!(i8, i8, -119i8, VT_I1);
    }
    #[test]
    fn test_u16() {
        validate_variant!(u16, u16, 119u16, VT_UI2);
    }
    #[test]
    fn test_u32() {
        validate_variant!(u32, u32, 11976u32, VT_UI4);
    }
    #[test]
    fn test_u64() {
        validate_variant!(u64, u64, 11976u64, VT_UI8);
    }
    #[test]
    fn test_box_i8() {
        type Bi8 = Box<i8>;
        validate_variant!(Bi8, Bi8,  Box::new(-119i8), VT_PI1);
    }
    #[test]
    fn test_box_u16() {
        type Bu16 = Box<u16>;
        validate_variant!(Bu16, Bu16, Box::new(119u16), VT_PUI2);
    }
    #[test]
    fn test_box_u32() {
        type Bu32 = Box<u32>;
        validate_variant!(Bu32, Bu32,  Box::new(11976u32), VT_PUI4);
    }
    #[test]
    fn test_box_u64() {
        type Bu64 = Box<u64>;
